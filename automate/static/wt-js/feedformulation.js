$(document).ready(function () {
  // Handle on Button Click animation
  $('#newFeedForm').on('submit', function () {
    // console.log('Clicked');
    if ($('#newFeedForm input') == ' ') {
      console.log();
    } else {
      $('#newFeedForm #submitButton').html('<div class="spinner-border spinner-border-sm"></div> Adding, Please Wait..');
    }
  });

  $('#updateFeedForm').on('submit', function () {
    // console.log('Clicked'R);
    if ($('#updateFeedForm input') == ' ') {
      console.log();
    } else {
      $('#updateFeedForm #submitButton').html('<div class="spinner-border spinner-border-sm"></div> Updating, Please Wait..');
    }
  });
  ...
  // Addition of new feedtype formula
  ...
  // Get the feedtype id to be deleted
  $(document).on('click', '.delete-button', function(){
    
    let id = $(this).attr('id');
    $('#feedtypeId').val(id)
    // console.log('feedtype', id);
  })
